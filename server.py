...
def images():
    ...
    if request.method == 'POST':
        ...
        return_json = ImageController.get_images(filed, page)
...
@app.route("/images/<int:image_id>", methods=['GET', 'PUT', 'DELETE'])
def image(image_id):
    ...
    if request.method == 'PUT':
        ...
        return_json = ImageController.get_image(image_id, filed)
    elif request.method == 'DELETE':
